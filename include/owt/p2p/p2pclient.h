...
class P2PClient final /* PIKA: disable inheritance */
    : protected P2PSignalingSenderInterface,
      protected P2PSignalingChannelObserver,
      public std::enable_shared_from_this<P2PClient> /* PIKA: for shared_ptr */ {
  friend class P2PPublication; /* PIKA: access both private and protected members of friend class*/
